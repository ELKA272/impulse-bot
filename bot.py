...
# ── Default events ──
DEFAULT_EVENTS = {
    "1": {"id": 1, "title": "🌿 Прогулка в Оленьи Ручьи", "date": "22 июня 2026",
          "time": "10:00", "location": "Екатеринбург, сбор у ТЦ Мега",
          "price": "500₽ (дорога + входной)", "desc": "Живописный маршрут вдоль реки Серга. Скалы, пещеры, пикник на природе.",
          "status": "active"},
    "2": {"id": 2, "title": "🧘 Практикум «Родовая медитация»", "date": "28 июня 2026",
          "time": "15:00", "location": "Екатеринбург, центр «Гармония»",
          "price": "800₽", "desc": "Глубокая медитация на восстановление родовых связей.",
          "status": "active"},
    "3": {"id": 3, "title": "🕯 Мастер-класс по свечам", "date": "2 июля 2026",
          "time": "14:00", "location": "Екатеринбург, студия «Творчество»",
          "price": "1200₽ (все материалы)", "desc": "Создай свою ароматическую свечу. Полная релаксация.",
          "status": "active"},
}
